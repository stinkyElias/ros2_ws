...
class Metaclass_AddThreeInts_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('tutorials_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tutorials_interfaces.srv.AddThreeInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from tutorials_interfaces.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from tutorials_interfaces.srv._add_three_ints import AddThreeInts_Request as Request
    from tutorials_interfaces.srv._add_three_ints import AddThreeInts_Response as Response
